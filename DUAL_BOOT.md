...
If the latest stable Surface kernel is 14.17.03, do not upgrade to a higher version kernel. 

Then, there are a few things which can be installed. See here for some bloatware clean-up. Most of the games can be removed for instance.
...
Then  the chosen editor, ESLint and Prettier can be installed and configured.
...
NB: restart postgreSQL by closing the CLI terminal and reopening then typing psql.
