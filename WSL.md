...
3.  ESLint, Nodemon and Testem: ESLintcan be installed on a per-project basis, AFAIK. Its config.json file can be set in the root, making it accessible from all the folders. Nodemon and Testem can be installed as global.
...
![Start Menu](/images/SketchWSL_3.png)
